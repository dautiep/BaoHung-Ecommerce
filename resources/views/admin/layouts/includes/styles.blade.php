...
<!-- SweetAlert2 -->
<link rel="stylesheet" href="{{ asset('admin/admin-lte/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css') }}">
<!-- Toastr -->
<link rel="stylesheet" href="{{ asset('admin/admin-lte/plugins/toastr/toastr.min.css') }}">
<!-- Theme style -->
...
<!-- summernote -->
<link rel="stylesheet" href="{{ asset('admin/admin-lte/plugins/summernote/summernote-bs4.min.css') }}">
