        ...
        <section class="content-header">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Danh Sách phân quyền</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a class="text-fibo" href="#">QL phân quyền</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="phoneSearch">Tên phân quyền</label>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    ...
                                                    <button role="button" class="btn btn-sm btn-danger"
                                                        ...
                                                        data-toggle="tooltip" title="Xóa phân quyền"><i
...
@section('scripts')
    <script>
        ...
        function cancelCategory(id_item) {
            ...
            Swal.fire({
                title: 'Bạn có chắc xóa phân quyền này không?',
                icon: 'warning',
