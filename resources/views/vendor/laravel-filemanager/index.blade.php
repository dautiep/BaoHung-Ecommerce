...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="{{ addVersionTo('vendor/laravel-filemanager/img/72px color.png') }}">
  ...
  <link rel="stylesheet" href="{{ addVersionTo('vendor/laravel-filemanager/css/cropper.min.css') }}">
  <link rel="stylesheet" href="{{ addVersionTo('vendor/laravel-filemanager/css/dropzone.min.css') }}">
  <link rel="stylesheet" href="{{ addVersionTo('vendor/laravel-filemanager/css/mime-icons.min.css') }}">
  <style>{!! \File::get(base_path('vendor/unisharp/laravel-filemanager/public/css/lfm.css')) !!}</style>
  {{-- Use the line below instead of the above if you need to cache the css. --}}
  {{-- <link rel="stylesheet" href="{{ addVersionTo('/vendor/laravel-filemanager/css/lfm.css') }}"> --}}
</head>
<body>
  ...
  <script src="{{ addVersionTo('vendor/laravel-filemanager/js/cropper.min.js') }}"></script>
  <script src="{{ addVersionTo('vendor/laravel-filemanager/js/dropzone.min.js') }}"></script>
  <script>
  ...
  {{-- <script src="{{ addVersionTo('vendor/laravel-filemanager/js/script.js') }}"></script> --}}
  <script>
