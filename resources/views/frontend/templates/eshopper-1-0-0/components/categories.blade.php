      ...
      <div class="container-fluid pt-5">
          <div class="row px-xl-5 pb-3">
              @foreach (@$categories_with_product as $category)
                  @if ($category->productWithCategory->count() == 0)
                      @continue;
                  @endif
                  <div class="col-lg-4 col-md-6 pb-1">
                      <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                          <p class="text-right">{{ $category->productWithCategory->count() }}
                          ...
                          <a href="{{ route('frontend.category', ['slug' => $category->slug]) }}"
                              ...
                              <img class="img-fluid image_product"
                                  src="{{ asset('admin/images/products/' . @$category->productWithCategory[0]->image_url) }}"
